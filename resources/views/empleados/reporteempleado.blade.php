@can('ver-socio')
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/responsive/2.2.9/css/responsive.5bootstrap4.min.css">
    @endsection
        ...
        @can('crear-socio')
            <a href="{{ route('empleados') }}">
                <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        class="fa fa-user-plus" aria-hidden="true"></i> Nuevo Socio</button>
            </a>
        @endcan
        <br>
        <br>
                        ...
                        <tbody>
                            @foreach($empleados as $empleado)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('archivos/' . $empleado->foto) }}"
                                        ...
                                        @can('eliminar-socio')
                                            <a
                                                ...
                                                <button type="button" class="btn btn-danger" id="btnElimina"
                                                    data-id="{{ $empleado->id_empleado }}"><i
